...
__decorate([
    ...
    __metadata("design:type", String)
], Award.prototype, "time", void 0);
__decorate([
    (0, typeorm_1.Column)({ nullable: true }),
    __metadata("design:type", Number)
], Award.prototype, "goalId", void 0);
__decorate([
    (0, typeorm_1.ManyToOne)(() => goal_entity_1.Goal, goal => goal.awards, { onDelete: 'SET NULL' }),
    __metadata("design:type", goal_entity_1.Goal)
], Award.prototype, "goal", void 0);
Award = __decorate([
    (0, typeorm_1.Entity)({ name: "award" })
], Award);
exports.Award = Award;
